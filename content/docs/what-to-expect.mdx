...
flowchart TB
  subgraph Rail["Connected — span"]
    ...
    subgraph Related["Related"]
      click["Click that caused this trace"]
      clickId["click_5"]
      click --> clickId
    end
  end
...
```mermaid
flowchart LR
  click["frontend click"] --> interaction["interaction_id"]
  interaction --> trace["backend trace_id"]
