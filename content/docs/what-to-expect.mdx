...
obs-unified is designed around one promise: **unified observability means every signal is reachable from every other in ≤2 clicks**. This page walks through what the dashboard actually surfaces once instrumentation is in place.
