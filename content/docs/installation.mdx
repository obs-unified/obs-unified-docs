...
This page covers cloning and running the **obs-unified monorepo** — the collector, dashboard, and TypeScript SDKs. If you just want to instrument a service with one of the published SDKs, jump to the [SDKs page](/docs/sdks) instead; the per-language install commands there don't require any of the prerequisites below.
