		...
		<main className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center gap-8">
			<div className="flex flex-col gap-4 max-w-2xl">
				...
				<p className="text-fd-muted-foreground text-base sm:text-lg">
					A single observability stack where every signal — traces, logs,
					AI calls, sessions, replays, alerts, profiles — is reachable
					from every other in ≤2 clicks. End-to-end click-to-CPU on
